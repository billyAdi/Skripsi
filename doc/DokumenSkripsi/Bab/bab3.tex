...
Berikut ini adalah \textit{option} yang akan diimplementasikan pada skripsi ini:
\begin{enumerate}
...
\item Program mendapatkan seluruh histori \textit{commit} dari repositori perangkat lunak berbasis web pada  menggunakan JGit. Jika terdapat \textit{option} \texttt{-branch}, program akan mendapatkan histori \textit{commit} pada suatu \textit{branch}. Jika tidak terdapat \textit{option} \texttt{-branch}, program akan mendapatkan seluruh histori \textit{commit} pada \textit{branch} master. 
...
\item Program melakukan \textit{checkout} dalam suatu rentang \textit{commit} tertentu. Jika tidak terdapat \textit{option} \texttt{-start-commit} dan \textit{option} \texttt{-stop-commit}, akan dilakukan \textit{checkout} ke semua \textit{commit}.
