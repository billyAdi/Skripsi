...
Prapengujian ini hanya menggunakan dua input. Input dimasukkan melalui argumen Command Line. Input dari program ini adalah alamat direktori proyek Piktora dan satu URL untuk membuka halaman \textit{web}. Langkah pada pengujian menggunakan langkah yang terdapat pada subbab \ref{sec:analisis_fitur_aplikasi}. 
