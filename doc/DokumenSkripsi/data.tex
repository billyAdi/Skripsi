...
Testing is done by trying to run this software using several websites and WebDriver. The result of software testing shows that software can run well on several WebDriver. Web page appear scrambled on EdgeDriver. Software can run well on several websites. The size of animation file depends on the number of commit in a repository. 
