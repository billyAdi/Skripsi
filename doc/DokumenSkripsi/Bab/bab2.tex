...
Kelas ini merepresentasikan kumpulan dari objek Option, yang mendeskripsikan kemungkinan \textit{option} pada \textit{command line}. Berikut ini adalah \textit{method} yang dimiliki kelas ini: 
\begin{itemize}
