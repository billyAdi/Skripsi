...
\begin{figure}[H]
	\centering
		\includegraphics[scale=0.4]{Gambar/gitcheckoutcommit.png}
...
\subsection{Git}
\label{subsec:Git}
Kelas ini menyediakan API yang mirip Git \textit{Command Line} untuk berinteraksi dengan repositori git. Berikut ini adalah beberapa \textit{method} dalam kelas ini:
\begin{itemize}
