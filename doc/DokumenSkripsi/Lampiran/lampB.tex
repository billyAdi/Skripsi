%versi 2 (8-10-2016)
\chapter{Library Untuk Membuat File GIF}
\label{lamp:B}
...
\lstinputlisting[language=Java, caption=GifSequenceWriter.java]{../../Program/TimeLapseGenerator/src/main/java/id/ac/unpar/timelapsegenerator/GifSequenceWriter.java}
