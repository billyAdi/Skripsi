...
%belum beres 
Program pada skripsi ini memiliki dua fitur. Fitur utama dari program ini adalah membangkitkan animasi timelapse. Selain itu, perangkat lunak dapat membaca masukan dan konfigurasi dari Command Line Options yang dimasukkan oleh \textit{user}. Penjelasan fitur-fitur pada perangkat lunak dapat dilihat pada Gambar.... dan Tabel.... hingga ..... 
